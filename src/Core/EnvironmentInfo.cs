...
/// <summary>
/// Дані про середовище виконання. Це record — він лише зберігає значення
/// (результат вимірювання), а не має життєвого циклу чи поведінки.
/// </summary>
...
/// <summary>
/// Збирає інформацію про середовище виконання. Це static class — тут є
/// алгоритм (поведінка), а не набір полів. Повертає дані, а НЕ друкує їх:
/// друк — це робота Cli.
/// </summary>
